...
public class Controller05 {
	...
	// 연습 : /cont05/met02 로 요청이 오면 /WEB-INF/views/view02.jsp 로 forward 
	...
	public String method05() {
		...
		*/
		...
		/* spring mvc 사용 시 */
		// redirect를 붙이면 redirect, 안붙이면 forward
		return "redirect:/cont05/met04";
		
	}
	
	// 연습 : /cont05/met06 요청이 왔을 때 /cont05/met04 로 redirect 되는 method06
	...
	// 연습 : /cont05/met09 로 요청이 왔을 때 
	// 		/WEB-INF/views/cont05/met09.jsp 로 포워드 되도록 method09 작성
