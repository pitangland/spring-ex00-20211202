...
<script>
	$(document).ready(function () {
		...
		// 아이디 중복확인 버튼이 클릭되면 
		// 아이디 input 요소에 입력된 값을
		// 서버에 전송 후, 응답 받은 값에 따라
		...
		$("#idCheckButton").click(function () {
			...
			// 아이디 input에 입력이 안되었을 경우 더이상 진행하지 않고
			// 아이디를 입력하라는 메세지 출력
			if (idValue === "") {
				$("#idCheckMessage")
					.text("아이디를 입력해주세요.")
		...
		// 암호 input과 암호확인 input 값을 비교해서 서브밋 버튼 활성화 또는 비활성화
		const confirmFunction = function () {

			// 두 개의 인풋요소의 값이 같을 때만 submit 버튼 활성화 또는 비활성화
