...
<body>
			...
			<div class="col">
				...
				<form method="post" id="infoForm">
					...
					<div class="form-group">
						...
						<input type="password" required id="input2" class="form-control" name="password" value="${loggedInMember.password }">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="email" required id="input3" class="form-control" name="email" value="${loggedInMember.email }">
					</div>
					<div class="form-group">
	...
	<script>
		$(document).ready(function() {
			...
			// password 확인 nickName 중복확인이 완료되었을 경우, 수정 버튼 활성화
