...
<button id="btn06">/cont13/met05 요청 성공시 log</button> <br>
<button id="btn07">/cont13/met06 응답받은 데이터 콘솔에 출력</button> <br>
<button id="btn08">/cont13/met07 응답받은 데이터(1~10 랜덤값)를 #result08 요소에 content로 작성</button> <br>
<p id="result08"></p> <br>
<button id="btn09">/cont13/met08 요청 완료시 complete 실행</button> <br>
